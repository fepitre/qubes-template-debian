...
# ==============================================================================
# Umount everthing within INSTALL_DIR or $1 but kill all processes within first
# ==============================================================================
function umount_all() {
...
EOF
        ...
        chroot_cmd apt-key add - < ${TEMPLATE_CONTENT_DIR}/../keys/qubes-debian-r${USE_QUBES_REPO_VERSION}.asc
    fi
}
